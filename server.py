...
def dateParser(line):
    ...
    # se o analisador fuzzy não conseguiu analisar a linha devido a
    # problema de informação de fuso horário incorreto 
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Analise de Email - Headers")
